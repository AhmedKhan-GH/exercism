...
def check_drinks(drink_name, drink_ingredients):
    ...
    if (set(drink_name) | set(drink_ingredients)) & ALCOHOLS:
...
def tag_special_ingredients(dish):
    ...
    # return the special ingredients of a given set
