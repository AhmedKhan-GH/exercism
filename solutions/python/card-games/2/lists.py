...
def approx_average_is_average(hand):
    ...
    terminal_avg = (hand[0] + hand[-1])/2

  
    return terminal_avg == true_average or median(hand) == true_average
...
def average_even_is_average_odd(hand):
    ...
    if not (even_hand and odd_hand):
        return False

    even_avg = card_average(even_hand)
    odd_avg = card_average(odd_hand)
