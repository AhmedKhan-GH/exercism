...
def higher_card(card_one, card_two):
    ...
    one_val = value_of_card(card_one)
    two_val = value_of_card(card_two)
...
def is_blackjack(card_one, card_two):
    ...
    one_ten = card_one in {'10', 'K', 'Q', 'J'} 
    two_ten = card_two in {'10', 'K', 'Q', 'J'}

    return has_ace and (one_ten or two_ten)
