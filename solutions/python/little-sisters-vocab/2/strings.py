...
def make_word_groups(vocab_words):
    ...
    # we get the prefix, and then betweeen that word and all other words we get the separator colon with the prefix on the right preventing the double prefix
