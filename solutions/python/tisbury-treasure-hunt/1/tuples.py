...
def clean_up(combined_record_group):
    ...
    # we just need to get rid of the printed coordinate and keep the tuple coordinate
 # we create the tuple on the inside and then print it not formatting a canonical tuple string representation manually
